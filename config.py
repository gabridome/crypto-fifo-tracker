...
EXCHANGE_COUNTRIES = {
    ...
    "Bybit":          {"iso": "AE", "at_code": "784", "at_name": "Emirados Arabes Unidos"},
    "changely":       {"iso": "EE", "at_code": "233", "at_name": "Estonia"},
